...
class BatchTASK(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str,EcrRepo="default",UserName="default",**kwargs):
        ...
        # self.String_Echo = _batch.CfnJobDefinition(self,"String_Echo",
        #     job_definition_name="String_Echo",
        #     type="container",
        #     container_properties={
        #         "image":"238090515572.dkr.ecr.ap-northeast-1.amazonaws.com/example/string_echo:latest",
        #         "vcpus":2,
        #         "memory":512,
        #         "command":["/bin/sh","/data/run.sh"],
        #         "environment":[
        #             {"name":"INPUT_FILE","value":""},
        #             {"name":"INPUT_DIR","value":"/data/"},
        #             {"name":"OUTPUT_DIR","value":"/data/"}
        #         ]
        #     },
        ...
        self.String_Split = _batch.JobDefinition(self,"String_Split",
            ...
            container = _batch.JobDefinitionContainer(
                ...
                # image = _ecs.ContainerImage.from_registry(name="238090515572.dkr.ecr.ap-northeast-1.amazonaws.com/example/string_split:latest"),
        ...
        self.String_Reverse = _batch.JobDefinition(self,"String_Reverse",
            ...
            container = _batch.JobDefinitionContainer(
                ...
                # image = _ecs.ContainerImage.from_registry(name="238090515572.dkr.ecr.ap-northeast-1.amazonaws.com/example/string_reverse:latest"),
                memory_limit_mib = 1024,
                vcpus = 1,
                command = [
                    "/bin/bash",
        ...
        self.String_Repeat = _batch.JobDefinition(self,"String_Repeat",
            ...
            container = _batch.JobDefinitionContainer(
                ...
                # image = _ecs.ContainerImage.from_registry(name="238090515572.dkr.ecr.ap-northeast-1.amazonaws.com/example/string_repeat:latest"),
                memory_limit_mib = 1024,
                vcpus = 1,
                command = [
                    "/bin/bash",
        ...
        self.String_Merge = _batch.JobDefinition(self,"String_Merge",
            ...
            container = _batch.JobDefinitionContainer(
                ...
                # image = _ecs.ContainerImage.from_registry(name="238090515572.dkr.ecr.ap-northeast-1.amazonaws.com/example/string_merge:latest"),
                memory_limit_mib = 1024,
                vcpus = 1,
                command = [
                    "/bin/bash",
